...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-10-2025 a las 01:33:57
...
INSERT INTO `planes` (`id_plan`, `nombre`, `descripcion`, `precio`, `duracion_dias`) VALUES
(1, 'Gratis', 'Plan básico con acceso limitado. Hasta 1 proyecto y 5 tareas activas.', 0.00, 30),
(2, 'Starter', 'Ideal para usuarios individuales. Hasta 5 proyectos y 50 tareas activas.', 4.99, 30),
(3, 'Pro', 'Pensado para equipos pequeños. Hasta 20 proyectos, usuarios ilimitados y 500 tareas activas.', 14.99, 30),
(4, 'Business', 'Para empresas. Proyectos ilimitados, integración avanzada y soporte prioritario.', 29.99, 30),
(5, 'Anual Pro', 'Mismo que el plan Pro, pero con descuento por pago anual.', 149.99, 365);
